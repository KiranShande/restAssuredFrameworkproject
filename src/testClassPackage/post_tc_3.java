...
public class post_tc_3 {
	...
	public static void execute() throws IOException {
		for(int i=0 ; i<5 ; i ++) 
		{
			...
			String requestBody=post_req_respository.post_request3();
			...
			if(statusCode== 201) 
			{
         	...
         	utility_CommonFunctions.evidencecreater("post_tc_3", responseBody, responseBody);
         	break;
			}
			else 
			{
	...
	Assert.assertEquals(res_name, "john");
	Assert.assertEquals(res_job, "ceo");
